export const en = {
  ...
  settingsIntro:
    'Effective local configuration and storage roles used by this installation.',
  settingsLoading: 'Loading effective configuration…',
  settingsError: 'Unable to load Settings: {error}',
  settingsRuntimePaths: 'Runtime locations',
  settingsRuntimePathsDescription:
    'These are the effective locations currently used by LeLe Manager.',
  settingsVersion: 'Application version',
  settingsHealth: 'Runtime health',
  ...
  diagnosticsIntro:
    'Generate a bounded local support report. No lesson contents, candidate contents, secrets, or arbitrary environment variables are included.',
  diagnosticsGenerate: 'Generate preview',
  diagnosticsGenerating: 'Generating preview…',
  diagnosticsPreviewTitle: 'Exact export preview',
  diagnosticsPreviewHelp:
    'The JSON below is exactly what will be saved to the diagnostic file.',
  diagnosticsExport: 'Save diagnostic JSON',

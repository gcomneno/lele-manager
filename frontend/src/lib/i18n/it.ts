...
export const it = {
  ...
  settingsIntro:
    'Configurazione locale effettiva e ruoli di archiviazione usati da questa installazione.',
  settingsLoading: 'Caricamento della configurazione effettiva…',
  settingsError: 'Impossibile caricare le Impostazioni: {error}',
  ...
  settingsVersion: 'Versione applicazione',
  settingsHealth: 'Stato runtime',
  ...
  diagnosticsTitle: 'Diagnostica per assistenza',
  diagnosticsIntro:
    'Genera un rapporto locale e limitato per l’assistenza. Non include contenuti delle LeLe, contenuti dei candidati, segreti o variabili di ambiente arbitrarie.',
  diagnosticsGenerate: 'Genera anteprima',
  diagnosticsGenerating: 'Generazione anteprima…',
  diagnosticsPreviewTitle: 'Anteprima esatta dell’esportazione',
  diagnosticsPreviewHelp:
    'Il JSON seguente è esattamente ciò che verrà salvato nel file diagnostico.',
  diagnosticsExport: 'Salva diagnostica JSON',

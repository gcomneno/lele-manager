...
def test_stats_and_vault_use_public_giada_ui_components() -> None:
    ...
    # Vault management, snapshot preview, typed restore confirmation, transfer
    # preview/execute actions, and the existing Vault actions are distinct
    # design-system action groups.
    assert vault.count("<FormActions") == 6
